<template>
  <b-container>
    <div class="fw-bold text-start text-white mb-5">
      <h1>당신만을 위한 영화 추천 <i class="far fa-thumbs-up"></i></h1>
    </div>
    ...
    <div class="mb-5">
      ...
      <div v-else-if="recommendMovieListsByUsers.length > 0">
        <movie-image-list
          v-for="(
            recommendMovieListByUsers, index
          ) in recommendMovieListsByUsers"
          :key="index"
          :movieList="recommendMovieListByUsers"
        ></movie-image-list>
      </div>
    ...
    <div class="mb-5">
      ...
      <div v-else-if="recommendMovieListsByReviews.length > 0">
        <movie-image-list
          v-for="(
            recommendMovieListByReview, index
          ) in recommendMovieListsByReviews"
          :key="index"
          :movieList="recommendMovieListByReview"
        ></movie-image-list>
      </div>
      <div v-else class="fw-bold text-start text-white">
    ...
    <div class="mb-5">
      ...
      <div v-else>
        <movie-image-list
          v-for="(recommendMovieListByYun, index) in recommendMovieListsByYun"
          :key="index"
          :movieList="recommendMovieListByYun"
        ></movie-image-list>
      </div>
    </div>
    ...
    <div class="mb-5">
      ...
      <div v-else>
        <movie-image-list
          v-for="(recommendMovieListBySang, index) in recommendMovieListsBySang"
          :key="index"
          :movieList="recommendMovieListBySang"
        ></movie-image-list>
      </div>
    </div>
  </b-container>
